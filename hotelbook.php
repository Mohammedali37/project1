		...
		<div class="row justify-content-center">
			<div class="col-lg-7 col-md-10">
				<div class="trip-form-section">
					...
					<form class="trip-form-area trip-page-form trip-form text-right" action="includes/hotelbook.inc.php"
						method="POST">
						...
						<div class="form-group col-md-12">
							<input type="text" class="form-control" name="qty" placeholder="room" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'room'">
						</div>
