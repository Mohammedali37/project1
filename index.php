			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-center">
					<div class="banner_content">
						<p>Plan a trip for travel around world</p>
						<h2> Adventure</h2>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row team_inner">
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="img/team/ct2.jpg" alt="">
							<div class="hover">
								<h4>Mohammed ali</h4>
								<p>Student of EWU CSE</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="img/team/ct1.jpg" alt="">
							<div class="hover">
								<h4>Tanvirul Islam</h4>
								<p>Student of EWU CSE</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="img/team/ct3.jpg" alt="">
							<div class="hover">
								<h4>rahul saha</h4>
								<p>Student of EWU CSE</p>
							</div>
